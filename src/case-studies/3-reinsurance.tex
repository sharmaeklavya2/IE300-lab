...
\item Create QQ plots of this data (i.e., log of amounts) w.r.t.~the exponential distribution
    with parameter 1 and the standard normal distribution. Draw as scatter plots.
...
Compute the Hill estimator $\gammahat_k$.
\end{exercise}
\end{tcolorbox}
...
Write your answers with two decimal places, i.e.,

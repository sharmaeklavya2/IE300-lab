...
\subsection{Central Limit Theorem (18 points)}
...
\item \cref{exe:exp:y-plot} (4 points):
    1 point to plot the normal curve,
    2 points to plot $f_{Y_n}$,
    1 point for plot legend.
\item \cref{exe:par:ht} (3 points):
    2 points for (a),
    1 point for (b).
\item \cref{exe:par:ev} (5 points):
    2 points for (a),
    3 points for (b).
\item \cref{exe:pareto-vs-exp} (2 points)
\end{enumerate}

\subsection{QQ Plot (16 points)}

\begin{enumerate}
\item \cref{exe:unif-vs-norm-qq} (7 points):
    \begin{tightemize}
    \item 1 point for (a).
    \item 1 point for (b).
    \item 4 points for (c):
        2 points for the QQ plot,
        1 point for the reference line,
...
\subsection{Mean Excess Function and Reinsurance (16 points)}

\begin{enumerate}
\item \cref{exe:excess} (6 points):
    3 points for (a), 3 points for (b).
\item \cref{exe:pihat1-eq-pihat2} (3 points):
\item \cref{exe:hill} (4 points):

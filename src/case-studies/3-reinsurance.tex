...
\tcbset{
mathExe/.style={colback=blue!10!bgColor, frame empty, colupper=textColor},
progExe/.style={colback=orange!10!bgColor, frame empty, colupper=textColor},
}
...
\item Plot the standard normal distribution's density function on the interval $[-4, 4]$ as a dashed line.
    (You may use \href{https://docs.scipy.org/doc/scipy/reference/generated/scipy.stats.norm.html}{%
...
\item A Pareto random variable is heavy-tailed.
    \\ (Hint: you may want to use L'H\^opital's rule.)
...
\\ Hint: Use the same trick as in the hint of \cref{exe:exp:y-distr}.
\end{exercise}
\end{tcolorbox}

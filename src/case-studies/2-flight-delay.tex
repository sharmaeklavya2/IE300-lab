...
Consider the following table containing information of delays.
...
Using the following table, will the flight SEA-ATL on Southwest with good weather be delayed?
...
The dataset \texttt{FlightDelay.csv} contains 2,346 observations of flights
...
Using \texttt{FlightDelay.csv}, write Python code to perform the following:
